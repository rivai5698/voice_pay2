...
//
// class VoiceMessage2 extends StatefulWidget{
//   @override
//   _MyAppState createState() => _MyAppState();
//
// }
//
// class _MyAppState extends State<VoiceMessage2> {
//
//
//
//
...
//   Recording _current;
//   WebsocketManager socket = WebsocketManager('ws://103.74.122.136:8085/client/ws/speech?content-type=audio/x-raw,+layout=(string)interleaved,+rate=(int)44100,+format=(string)S16LE,+channels=(int)1');
...
//                               if (socket != null) {
//                                 socket.connect();
//                                 socket.send(String.fromCharCodes(_current).trim() + '\n');
//                                 socket.onMessage((dynamic _current){
//                                   print(_recorder);
//                                 });
//                               }
//                               break;
